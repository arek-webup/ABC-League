    ...
    <tr>
        <td align="center">
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td class="header">
                        <a href="https://accounts4life.com">
                            Accounts4life
                        </a>
                    </td>
                </tr>
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="content-cell">
                                    ...
                                    Thank you for using our store and purchasing our accounts. Here are details for your bought accounts:
                                    </br>
                                    <h3 style="text-align: center;">You bought: {{$name}}</h3>
                                    @foreach($code as $cc)
                                        <h/3 style="text-align: center;">{{$cc->code}}<h3>
                                    @endforeach
                                </td>
                            </tr>
                        </table>
